...
We also implement the Thomson sampling method~\cite{thompson1933likelihood} to compare with the result obtained with the CUCB algorithm. The pseudo is detailled in algorithm \ref{alg:thompson}.
